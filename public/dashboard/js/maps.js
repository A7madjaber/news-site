...
(function (_) {
    var ta, xa, Ba, Ca, Ea, Fa, Ga, Ha, Ya, Za, ib, tb, Jb, Kb, Lb, Nb, Ob, Rb, Sb, Ub, Vb, Wb, Yb, bc, jc, kc, lc, nc,
        ...
        re, ve, ye, Ae, Ce, Be, Ie, Ke, Me, Ne, Le, Pe, Se, Ue, Xe, Oe, Re, Te, Ye, af, bf, cf, sf, tf, uf, wf, xf, zf,
    ...
    _.T = function (a) {
        return new Promise(function (b, c) {
            var d = Pe.j(), e = "" + a;
            d.j[e] ? b(d.j[e]) : ((d.l[e] = d.l[e] || []).push({Hb: b, Lb: c}), Ue(d, e))
        })
    };
    _.Ze = function (a, b) {
        Pe.j().j["" + a] = b
...
*/
    ...
    var Pi = {vn: "Point", tn: "LineString", POLYGON: "Polygon"};
    var Qi = {
        CIRCLE: 0,
    ...
    var Nh = {
        ...
        NavigationControlStyle: {DEFAULT: 0, SMALL: 1, ANDROID: 2, ZOOM_PAN: 3, xn: 4, nj: 5},
        OverlayView: _.hh,
        Point: _.M,
        Polygon: _.qh,
        Polyline: _.rh,
