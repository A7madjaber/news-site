@extends('dashboard.layouts.index',['title'=>'تعديل مدير'])
@section('main')
    @push('dashboard_css')
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row mb-25">
                            ...
                            <div class="col-9">
                                <input class="form-control m-input " name="name" type="text" value="{{old('name',$admin->name)}}" id="example-text-input">
                        ...
                        <div class="form-group m-form__group row mb-25">
                            ...
                            <div class="col-9">
                                <input class="form-control m-input " name="email" type="email" value="{{old('email',$admin->email)}}" id="example-text-input">
                        ...
                        <div class="form-group m-form__group row mb-25">
                            ...
                            <div class="col-9">
                                ...
                                <select name="role" class="form-control select2">
                                    <option value="" selected disabled>اختار نوع الصلاحيات</option>
                        ...
                        <form id="single" action="{{csrf_token()}}">
                            <div class="fileinput fileinput-$new" data-provides="fileinput">
                                ...
                                <div class="fileinput-$new thumbnail"
                                    ...
                                    <img src="{{image_url($admin->image)}}" data-src="holder.js/100%x100%"
                                         alt="">
                                </div>
 ...
 max-height: 300px;"></div>
                ...
                <input id="image" name="image" hidden value="{{old('image',$admin->image)}}">
            </div>
        </div>
    </form>
