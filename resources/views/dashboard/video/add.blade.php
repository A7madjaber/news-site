...
@section('main')
    ...
    <form method="POST" action="{{route('dashboard.video.store')}}" accept-charset="UTF-8">
        @csrf
                        ...
                        <div class="m-portlet m-portlet--tab">
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control m-input" type="text" name="url" value="" required>
                                    </div>
                                </div>
 ...
 max-height: 300px;"></div>
            ...
            <input id="image" name="image" hidden value="">
