@extends('dashboard.layouts.index',['title'=>'تعديل صلاحية'])
@section('main')
    @push('dashboard_css')
    ...
    <form method="POST" action="{{route('dashboard.roles.update',[$Role->id])}}" accept-charset="UTF-8">
        @csrf
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row mb-25">
                            ...
                            <div class="col-9">
                                <input  class="form-control m-input " name="name" type="text" id="example-text-input" value="{{$Role->name,old('name')}}">
                            </div>
                        </div>
