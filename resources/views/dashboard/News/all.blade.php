@extends('dashboard.layouts.index',['title'=>'الأخبار'])
@section('main')
    @push('dashboard_css')
                        ...
                        <div class="m-portlet__body">
                            <div class="m-portlet__head-title col-sm-12">
                                ...
                                <a href="{{route('dashboard.news.create')}}">
                                    <button class="btn btn-primary col-sm-12" style="border-radius: 17px;">
                                        اضافة خبر جديد</button>
                                </a>

                           @else
                                    <a href="{{route('dashboard.news.create')}}">
                                        <button disabled class="btn btn-primary col-sm-12" style="border-radius: 17px;"> اضافة خبر جديد
                                        </button>
                                    </a>
                                    @endif
    ...
    @push('dashboard_js')
        ...
        <script>
            window.data_url = '{{route('dashboard.news.all.datatable')}}';
            window.columns = [{
