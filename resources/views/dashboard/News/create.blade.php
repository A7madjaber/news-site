    @extends('dashboard.layouts.index',['title'=>'خبر جديد'])
    @section('main')
        @push('dashboard_css')
        ...
        <form method="POST" action="{{route('dashboard.news.store')}}" accept-charset="UTF-8">
           @csrf
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row mb-25">
                            ...
                            <div class="col-9">
                                <input  class="form-control m-input " name="title" type="text" id="example-text-input" value="{{old('title')}}">
                        ...
                        <div class="form-group m-form__group row mb-25">
                            ...
                            <div class="col-9">
                                <input  class="form-control m-input " name="description" type="text" id="example-text-input" value="{{old('description')}}">
                        ...
                        <div class="form-group m-form__group row mb-25">
                            <label for="example-text-input" class="col-3 col-form-label">كلامات دلالية</label>
                            <div class="col-9">
                                <input name="tags" id="tags" class="form-control m-input" value="{{old('tags')}}"placeholder="الكلمات المفتاحية"/>
                            </div>
                        </div>

                        <div class="form-group m-form__group row mb-25">
                            <label for="example-text-input" class="col-3 col-form-label">تفاصيل الخبر</label>
                        <textarea id="m_summernote_1" name="details" class="form-control summernote" rows="30" style="display: none;">{{old('details')}}</textarea>
